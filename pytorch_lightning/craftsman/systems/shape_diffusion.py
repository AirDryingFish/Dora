...
from craftsman.systems.utils import read_image, preprocess_image, flow_sample
...
@craftsman.register("rectified-flow-system")
class RectifiedFlowSystem(BaseSystem):
    ...
    def configure(self):
        ...
        if self.cfg.visual_condition_type is not None:
            self.visual_condition = craftsman.find(
        ...
        self.denoiser_model = craftsman.find(self.cfg.denoiser_model_type)(
        ...
        self.noise_scheduler = craftsman.find(self.cfg.noise_scheduler_type)(
            **self.cfg.noise_scheduler
        )
        self.noise_scheduler_copy = copy.deepcopy(self.noise_scheduler)

        self.denoise_scheduler = craftsman.find(
